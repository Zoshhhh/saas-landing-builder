        ...
        <div className="mt-16 justify-between gap-8 md:flex flex-row-reverse">
          <div className="flex-1 flex flex-col border-y mt-6 md:max-w-xl md:rounded-xl md:border md:border-x-none md:shadow-lg md:mt-0">
            {plans.map((plan, index) => (
              <div key={index} className="p-4 py-8 border-b md:p-8">
                <div className="justify-between flex">
                  <div className="max-w-xs">
                    <span className="text-2xl text-gray-800 font-semibold sm:text-3xl">Pro Plan</span>
                    <p className="mt-3 sm:text-sm">
                      Perfect for developers looking to build and export stunning landing pages in Next.js.
                    </p>
                  </div>
                  <div className="flex-none text-gray-800 text-2xl font-semibold sm:text-3xl">
                    ${plan.price} <span className="text-xl text-gray-600 font-normal">{plan.duration}</span>
                  </div>
                </div>
