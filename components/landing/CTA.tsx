                ...
                <div className="gap-5 items-center lg:flex">
                    <div className="flex-1 max-w-lg py-5 sm:mx-auto sm:text-center lg:max-w-max lg:text-left">
                        <h2 className="text-3xl text-gray-800 font-semibold md:text-4xl">
                            Build your websites with <span className="text-blue-600">high performance</span>
                        </h2>
                        ...
                        <Link
                            href="/dashboard"
                            className="mt-5 px-4 py-2 text-blue-600 font-medium bg-blue-50 rounded-full inline-flex items-center hover:bg-blue-100 transition duration-150 ease-in-out"
                        >
                            Try it out
                            <svg
